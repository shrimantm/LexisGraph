...
export function Footer() {
  return (
    <footer id="contact" className="relative border-t border-white/[0.06] bg-[#07090f]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-12 py-16 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-slate-500">
              AI-powered legal compliance platform that uses knowledge graphs
              and GraphRAG to keep your organization ahead of regulatory
              changes.
            </p>
            {/* Socials */}
        ...
        {/* Bottom bar */}
        <div className="flex flex-col items-center justify-between gap-4 border-t border-white/[0.06] py-6 text-xs text-slate-600 sm:flex-row">
          <p>© {new Date().getFullYear()} LexisGraph. All rights reserved.</p>
          <p>Built with AI-powered compliance intelligence.</p>
        </div>
      </div>
    </footer>
  );
